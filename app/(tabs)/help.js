...
const faqs = [
  ...
  { q: 'How do I group food by category?', a: 'On the Home screen, tap "Group by Category" button on the top right. This switches from FlatList to SectionList view.' },
  { q: 'How do I remove a favourite?', a: 'Go to the Favourites tab, tap the ❤️ icon on the food you want to remove, then confirm by tapping "Remove".' },
];
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contactBox}>
          ...
          <Text style={styles.contactText}>Design By : Nurul Atira & Nurul Afiqah & Nur Zuriatie</Text>
...
const styles = StyleSheet.create({
  ...
  methodBadge: { backgroundColor: '#27AE60', paddingHorizontal: 10, paddingVertical: 3, borderRadius: 6 },
  postBadge: { backgroundColor: '#2980B9' },
  methodText: { color: '#fff', fontSize: 11, fontWeight: '800', letterSpacing: 1 },
  apiUrl: { color: '#aaa', fontSize: 12, flex: 1 },
